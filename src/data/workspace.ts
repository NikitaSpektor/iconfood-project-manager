...
export const TEMPLATES = [
  { id: 'tpl1', name: 'Открытие ресторана', steps: 8, icon: 'DoorOpen', hint: 'Аренда, ремонт, персонал, прогон, день Х' },
  { id: 'tpl2', name: 'Смена меню', steps: 6, icon: 'ChefHat', hint: 'Заявки, фудкост, дегустация, печать' },
  { id: 'tpl3', name: 'Обучение смены', steps: 5, icon: 'GraduationCap', hint: 'Скрипты, брони, тест, аттестация' },
  { id: 'tpl4', name: 'Инвентаризация', steps: 4, icon: 'ClipboardList', hint: 'Остатки, сверка, списание, акт' },
  { id: 'tpl5', name: 'Промо-кампания', steps: 7, icon: 'Megaphone', hint: 'Идея, съёмка, тексты, запуск, разбор' },
];
