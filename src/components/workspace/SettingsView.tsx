...
const faq = [
  ...
  },
  {
    ...
    a: 'Через раздел «Участники»: вводите рабочую почту, выбираете роль — приглашение уходит письмом с личным логином и паролем. Всего в холдинге 29 учётных записей.',
  },
];
