...
const faq = [
  ...
  },
  {
    ...
    a: 'Личная доска показывает только то, где вы ответственный. Общая доска холдинга собирает задачи всех ресторанов, фабрики и управляющей компании — её видят все участники, но менять карточки могут те, у кого есть права.',
  },
  {
    q: 'Что делают шаблоны задач?',
    a: 'В холдинге 12 шаблонов: открытие ресторана, смена основного и барного меню, обучение и развитие персонала, маркетинг и дизайн, закупки, технические задачи, эстетика, униформа, лояльность, доставка, производство на фабрике. Каждый разворачивает готовый чек-лист с реальными шагами.',
  },
  {
    q: 'Как добавить человека в проект?',
    a: 'Через раздел «Участники»: вводите рабочую почту, выбираете роль — приглашение уходит письмом с личным логином и паролем. Всего в холдинге 52 учётные записи.',
  },
];
