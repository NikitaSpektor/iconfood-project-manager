...
const faq = [
  ...
  },
  {
    ...
    a: 'В холдинге 12 шаблонов: открытие ресторана, смена основного и барного меню, обучение и развитие персонала, маркетинг и дизайн, закупки, технические задачи, эстетика, униформа, лояльность, доставка, инвентаризация. Каждый разворачивает готовый чек-лист с реальными шагами.',
  },
  {
